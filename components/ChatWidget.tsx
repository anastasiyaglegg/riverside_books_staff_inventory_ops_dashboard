...
// White roundel (matching the logo's white card) with a thin navy ring, so
// the illustration reads as art sitting on the badge rather than a solid
// navy button — cream tones from the original navy-background version are
// swapped for navy/deeper gold here so they stay visible against white.
    ...
    <div className="rb-panel">
      <div className="rb-header">
        <div className="rb-header-brand">
          <Image
            src="/logo.png"
            alt="Riverside Books & Gifts"
            width={32}
            height={32}
            className="rb-header-logo"
          />
